...
The format is based on [Keep a Changelog](https://keepachangelog.com/en/0.5.0/),
...
NxDI v0.5.0 is now production ready with enterprise-grade dependency injection features and superior performance compared to get_it.
