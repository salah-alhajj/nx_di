...
The format is based on [Keep a Changelog](https://keepachangelog.com/en/0.7.5/),
...
NxDI v0.7.5 is now production ready with enterprise-grade dependency injection features and superior performance compared to get_it.
